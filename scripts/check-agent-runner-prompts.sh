...
# SKILL.md 是运行时扫描的技能清单文件（container/skills/*/SKILL.md 与用户级
# ~/.claude/skills/*/SKILL.md），由 Agent 按需读取，不是 agent-runner 自带的
# prompts/ 提示词，故不参与存在性校验。
NON_PROMPT_MD='^(CLAUDE|CLAUDE\.local|SKILL)\.md$'
